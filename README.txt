Multi-Attention Spatio-Temporal Dynamic-DeepHit Implementation with PyTorch
...
The attention mechanism is done using multi-head attention instead of temporal attention
